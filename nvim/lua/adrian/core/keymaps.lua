...
keymap.set("n", "<leader>on", "<cmd>tabnew<CR>", { desc = "Open new tab" }) -- open new tab
...
keymap.set("n", "<leader>oc", "<cmd>tabnew %<CR>", { desc = "Open current buffer in new tab" }) --  move current buffer to new tab
